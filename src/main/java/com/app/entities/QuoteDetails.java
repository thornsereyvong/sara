...
public class QuoteDetails{
	...
	private String generatCommission;
	...
	public String getGeneratCommission() {
		return generatCommission;
	}

	public void setGeneratCommission(String generatCommission) {
		this.generatCommission = generatCommission;
	}
