...
app.controller('campController',['SweetAlert','$scope','$http',function(SweetAlert, $scope, $http){
	...
	$scope.listStatus = function(){
		$http.get("${pageContext.request.contextPath}/camp_status/list").success(function(response){
...
$(document).ready(function(){
	...
	$('#form_status').bootstrapValidator({
		...
		if($("#btn_save").val() == "Save"){
			$.ajax({
				url : "${pageContext.request.contextPath}/camp_status/add",
				type : "POST",
				data : JSON.stringify({ 
				      "statusName": $("#name").val(),
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/camp_status/edit",
				type : "PUT",
				data : JSON.stringify({
					  "statusID": $("#id").val(), 
				      "statusName": $("#name").val(),
...
<div class="content-wrapper" ng-app="campaign" id="campController" ng-controller="campController">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>Campaign Status</a></li>
		</ol>
	</section>
