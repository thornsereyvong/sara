...
app.controller('campController',['SweetAlert','$scope','$http',function(SweetAlert, $scope, $http){
	...
	$scope.listStatus = function(){
		$http.get("${pageContext.request.contextPath}/case_status/list").success(function(response){
	...
	$scope.listStatusID = function(id){
			$http.get("${pageContext.request.contextPath}/case_status/list/"+id).success(function(response){
	...
	$scope.deleteStat = function(leadID){
        ...
        function(isConfirm){ //Function that triggers on user action.
            if(isConfirm){
	            $http.delete("${pageContext.request.contextPath}/case_status/remove/"+leadID)
	            .success(function(){
	            		SweetAlert.swal({
			            		title:"Deleted",
...
$(document).ready(function(){
	...
	$('#form_status').bootstrapValidator({
		...
		if($("#btn_save").val() == "Save"){
			$.ajax({
				url : "${pageContext.request.contextPath}/case_status/add",
				type : "POST",
				data : JSON.stringify({ 
				      "statusName": $("#name").val(),
				      "statusDes": $("#desc").val()
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/case_status/edit",
				type : "PUT",
				data : JSON.stringify({
					  "statusId": $("#id").val(), 
				      "statusName": $("#name").val(),
...
<div class="content-wrapper" ng-app="campaign" id="campController" ng-controller="campController">
	...
	<section class="content-header">
		<h1>Case Status</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>Case Status</a></li>
		</ol>
	</section>
