				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input type="text" class="form-control pull-right date2" name="ts_startDate" id="ts_startDate" readonly="readonly">
									</div> 
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input type="text" class="form-control pull-right date2" name="ts_dueDate" id="ts_dueDate" readonly="readonly">
									</div> 
								</div>
							</div>
							<div class="clearfix"></div>
							...
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3" data-ng-init="listContact()">
