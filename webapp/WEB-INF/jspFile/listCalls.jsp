			...
			<div class="tablecontainer table-responsive" data-ng-init="listContact()" > 
				...
				<table class="table table-hover" >
						...
						<tr dir-paginate="cc in contact |orderBy:sortKey:reverse |filter:search |itemsPerPage:5">
							...
							<td>
								<a href="${pageContext.request.contextPath}/update-call/{{cc.callId}}" class="btn btn-success custom-width"><i class="fa fa-pencil" aria-hidden="true"></i></a>
								<button type="button" ng-click="deleteCon(cc.callId)" class="btn btn-danger custom-width"><i class="fa fa-times" aria-hidden="true"></i></button>
							</td>
						</tr> 
