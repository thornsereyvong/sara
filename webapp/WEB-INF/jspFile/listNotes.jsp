			...
			<div class="box-header with-border">
				...
				<div style="background: #fff;margin-top: 15px;">
				 <div class="col-sm-12">
				 	...
				 	<a href="${pageContext.request.contextPath}/view-notes" class="btn btn-info btn-app" ><i class="fa fa-clone"	aria-hidden="true"></i> View</a>
				 </div>
			...
			<div class="tablecontainer table-responsive" data-ng-init="listContact()" > 
				...
				<table class="table table-hover" >
						...
						<tr dir-paginate="cc in contact |orderBy:sortKey:reverse |filter:search |itemsPerPage:5">
							...
							<td>{{cc.noteDes}}</td>
							<td>
								<a href="${pageContext.request.contextPath}/update-note/{{cc.noteId}}" class="btn btn-success custom-width"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
