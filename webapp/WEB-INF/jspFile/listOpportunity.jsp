		...
		<div class="box box-danger">
			<div class="box-header with-border">
				...
				<div style="background: #fff;margin-top: 15px;">
				 <div class="col-sm-12">
				 	...
				 	<a href="${pageContext.request.contextPath}/view-opportunity" class="btn btn-info btn-app" ><i class="fa fa-clone"	aria-hidden="true"></i> View</a>
				 </div>
			...
			<div class="tablecontainer table-responsive" data-ng-init="listOpportunity()" >
				...
				<table class="table table-hover" >
						...
						<tr dir-paginate="cc in opportunity |orderBy:sortKey:reverse |filter:search |itemsPerPage:5">
							<td>{{cc.opId}}</td>
							<td>{{cc.opName}}</td>
							<td>{{cc.custName}}</td>
							<td>{{cc.osName}}</td>
