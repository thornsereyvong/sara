...
app.controller('campController',['$scope','$http',function( $scope, $http){
	...
	$scope.deleteOpp = function(oppID){
		...
		if(str == "YES"){
			swal({   
				title: "<span style='font-size: 25px;'>You are about to delete opportunity with ID: <span class='color_msg'>"+oppID+"</span>.</span>",   
				...
				setTimeout(function(){			
					$.ajax({ 
			    		url: "${pageContext.request.contextPath}/opportunity/remove/"+oppID,
			    		method: "DELETE",
