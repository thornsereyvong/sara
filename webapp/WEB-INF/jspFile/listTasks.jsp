		...
		<div class="box box-danger">
			<div class="box-header with-border">
				...
				<div style="background: #fff;margin-top: 15px;">
				 <div class="col-sm-12">
				 	<a href="${pageContext.request.contextPath}/create-task" class="btn btn-info btn-app" ><i class="fa fa-plus" aria-hidden="true"></i> Create</a>
				 	<a href="${pageContext.request.contextPath}/view-tasks" class="btn btn-info btn-app" ><i class="fa fa-clone"	aria-hidden="true"></i> View</a>
				 </div>
			...
			<div class="tablecontainer table-responsive" data-ng-init="listContact()" > 
				...
				<table class="table table-hover" >
						<tr>
							<th style="cursor: pointer;" ng-click="sort('taskId')">Task ID
								<span class="glyphicon sort-icon" ng-show="sortKey=='taskId'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}">
							</th>
							<th style="cursor: pointer;" ng-click="sort('taskSubject')">Subject 
								<span class="glyphicon sort-icon" ng-show="sortKey=='taskSubject'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}">
							</th>
							<th style="cursor: pointer;" ng-click="sort('taskStartDate')">Start Date
								<span class="glyphicon sort-icon" ng-show="sortKey=='taskStartDate'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}">
							</th>
							<th style="cursor: pointer;" ng-click="sort('taskDueDate')">Due Date 
								<span class="glyphicon sort-icon" ng-show="sortKey=='taskDueDate'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}">
							</th>
						...
						<tr dir-paginate="cc in contact |orderBy:sortKey:reverse |filter:search |itemsPerPage:5">
							...
							<td>
								<a href="${pageContext.request.contextPath}/update-task/{{cc.taskId}}" class="btn btn-success custom-width"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
								<button type="button" ng-click="deleteCon(cc.taskId)" class="btn btn-danger custom-width"><i class="fa fa-times" aria-hidden="true"></i> Delete</button>
							</td>
						</tr>
