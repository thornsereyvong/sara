...
<script src="${pageContext.request.contextPath}/resources/js.mine/sale-order/sale_order_edit.js"></script>
	...
	function listDataSalOrdByID(data){
		...
		if(data != ""){
			...
			for(var i=0;i<data.saleOrderDetails.length;i++){
				...
				$("#uom"+index).select2('val',data.saleOrderDetails[i].uomId);
