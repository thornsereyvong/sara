...
<div class="content-wrapper" class="content-wrapper" ng-app="campaign"
	...
	<script type="text/javascript">
				...
				.controller(
						...
						[
								...
								function(SweetAlert, $scope, $http) {
									...
									$scope.editLeadOnStartup = function(
											username, leadId) {
										$http(
												{
													method : 'POST',
		...
		function listSources(sourceId, leadSource) {
			$("#lea_source").empty().append(
					'<option value="">-- SELECT Source --</option>');
			$.each(leadSource, function(key, value) {
				var div = "<option value='"+value.sourceID+"' >"
		...
		function listIndustries(industryId, industries) {
			...
			$("#lea_industry").empty().append(
					'<option value="">-- SELECT Industry --</option>');
			$.each(industries, function(key, value) {
				var div = "<option value='"+value.industID+"' >"
						+ value.industName + "</option>";
		...
		function listCampaigns(campId, campaigns) {
			$("#lea_ca").empty().append(
					'<option value="">-- SELECT Campiagn --</option>');
			$.each(campaigns, function(key, value) {
				var div = "<option value='"+value.campID+"' >" + value.campName
						+ "</option>";
				$("#lea_ca").append(div);
			});
		...
		function setLeadDateToForm(response) {
			...
			userAllList(response.ASSIGN_TO, '#lea_assignTo',
					result.assignToUserID);
...
.padding-right {
	...
	<section class="content">
		...
		<div class="box box-danger">
			...
			<div class="box-body"
				data-ng-init="editLeadOnStartup('${SESSION}','${leadId}')">

				<form method="post" id="form-leads">

					<a class="btn btn-info btn-app" id="btn_save"> <i
						class="fa fa-save"></i> Save
					</a> <a class="btn btn-info btn-app" id="btn_clear"> <i
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<label class="font-label">First Name <span
										class="requrie">(Required)</span></label>
									<div class="form-group">
										<div class="input-group">
											<span class="input-group-btn"> <select class="btn"
												style="height: 34px; width: 75px; text-align: center"
												name="lea_salutation" id="lea_salutation">
											...
											</span> <input type="text" name="lea_firstName" class="form-control"
												id="lea_firstName">
										</div>
									</div>
								</div>
								...
								<div class="col-sm-6">
									<label class="font-label">Last Name <span
										class="requrie">(Required)</span></label>
									<div class="form-group">
										<input type="text" class="form-control" id="lea_lastName"
											name="lea_lastName">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_title"
											name="lea_title">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_department"
											name="lea_department">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_accountName"
											name="lea_accountName">
									</div>
								</div>
							...
							<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<label>Phone </label>
									<div class="form-group">
										<input type="text" class="form-control" id="lea_phone"
											name="lea_phone">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_mobilePhone"
											name="lea_mobilePhone">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_website"
											name="lea_website">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_email"
											name="lea_email">
									</div>
								</div>
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_no"
											name="lea_no">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_street"
											name="lea_street">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_village"
											name="lea_village">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_commune"
											name="lea_commune">
									</div>
								</div>
								...
								<div class="col-sm-12">
									...
									<div class="form-group">
										<textarea style="height: 120px" rows="" cols=""
											name="lea_description" id="lea_description"
							...
							<div class="col-sm-6">
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_district"
											name="lea_district">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_city"
											name="lea_city">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_state"
											name="lea_state">
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" id="lea_country"
											name="lea_country">
									</div>
								</div>
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<select class="form-control select2" name="lea_industry"
											id="lea_industry" style="width: 100%;">
											<option value="">-- SELECT Industry --</option>
										</select>
									</div>
								</div>
							...
							<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<label class="font-label">Campaign <span
										class="requrie">(Required)</span></label>
									<div class="form-group">
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="col-sm-6">
									...
									<div class="form-group">
										<select class="form-control select2" name="lea_assignTo"
											id="lea_assignTo" style="width: 100%;">
