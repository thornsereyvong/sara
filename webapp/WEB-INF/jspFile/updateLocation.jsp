...
<div class="content-wrapper" ng-app="campaign" ng-controller="campController">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Update Location</a></li>
		</ol>
	</section>
...
function listDataByCampID(){
	...
	$("#id").val(result.loId);
	$("#name").val(result.loName);
	$("#no").val(result.loNo);
	$("#street").val(result.loStreet);
	$("#village").val(result.village);
	$("#commune").val(result.loCommune);
	$("#district").val(result.loDistrict);
	$("#city").val(result.loCity);
	$("#state").val(result.loState);
	$("#country").val(result.loCountry);
