	...
	<section class="content">
		...
		<div class="box box-danger">
			...
			<form method="post" id="form-note">
				<div class="col-sx-12 col-sm-12 col-md-12 col-lg-12" style="-5px;">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
							...
							<div class="form-group">
								<select class="form-control select2" name="me_relateTo" style="width: 100%;" id="me_relateTo">
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
							...
							<div class="form-group">
								<select class="form-control select2" name="me_reportType" style="width: 100%;" id="me_reportType">
