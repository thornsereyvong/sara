...
app.controller('campController',['SweetAlert','$scope','$http',function(SweetAlert, $scope, $http){
	...
	$scope.getNameCustomer= function(val){
			$http.get("${pageContext.request.contextPath}/customer/list/"+val).success(function(response){
				$scope.name_cus = response.DATA;
		});
	};
			...
			<div class="box-header with-border">
				...
				<div style="background: #fff;margin-top: 15px;">
				 <div class="col-sm-12">
				 	...
				 	<a href="${pageContext.request.contextPath}/list-cases" class="btn btn-info btn-app" ><i class="fa fa-clone"	aria-hidden="true"></i> View</a>
				    ...
				    <div role="tabpanel" class="tab-pane active" id="home">
				    	<div class="col-sm-6">
								<table class="table table-hover">
									<tr>
										<td width="200px"><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Case ID</td>
										<td>{{cc.caseId}}</td>
									</tr>
									<tr>
							...
							<div class="col-sm-6">
								<table class="table table-hover">
									<tr>
										<td width="200px"><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Subject</td>
										<td>{{cc.subject}}</td>
									</tr>
									<tr>
									...
									<tr>
										<td><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Resolution </td>
										<td>{{cc.resolution}}</td>
									</tr>
