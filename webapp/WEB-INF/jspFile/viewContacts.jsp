			...
			<div class="col-md-12">
				...
				<div class="box box-widget widget-user">
					...
					<div class="widget-user-header bg-aqua-active">
						<h3 class="widget-user-username">{{contact.conSalutation}}{{contact.conFirstName}} {{contact.conLastName}}</h3>
					...
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-sm-3 border-right">
								<div class="description-block">
									<h5 class="description-header">{{contact.conTitle}}</h5>
									<span class="description-text">Title</span>
								</div>
							</div>
							<div class="col-sm-3 border-right">
								<div class="description-block">
									<h5 class="description-header">{{contact.conPhone}}</h5>
									<span class="description-text">Tel</span>
								</div>
							</div>
							<div class="col-sm-3 border-right">
								<div class="description-block">
									<h5 class="description-header">{{contact.conEmail}}</h5>
