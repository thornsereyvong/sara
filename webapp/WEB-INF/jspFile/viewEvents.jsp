...
var app = angular.module('eventApp', ['angularUtils.directives.dirPagination','angular-loading-bar', 'ngAnimate']).config(['cfpLoadingBarProvider', function(cfpLoadingBarProvider) {
...
<div class="content-wrapper" id="vieweventController" ng-app="eventApp"
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="box box-widget widget-user">
					...
					<div class="widget-user-header bg-aqua-active">
						<h3 class="widget-user-username">{{event.evName}}</h3>
						<h5 class="widget-user-desc" ng-if="event.eventRelatedToModuleType != ''">NAME</h5>
					</div>
					<div class="widget-user-image">
						<img class="img-circle"
							src="${pageContext.request.contextPath}/resources/images/module/Event.png"
							alt="User Avatar">
					</div>
