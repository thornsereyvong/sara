			...
			<div class="box-header with-border">
				...
				<div style="background: #fff;margin-top: 15px;">
				 <div class="col-sm-12">
				 	...
				 	<a href="${pageContext.request.contextPath}/list-meetings" class="btn btn-info btn-app" ><i class="fa fa-clone"	aria-hidden="true"></i> View</a>	
				 </div>
				    ...
				    <div role="tabpanel" class="tab-pane active" id="home">
				    	<div class="col-sm-6">
								<table class="table table-hover">
									<tr>
										<td width="200px"><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Meeting ID</td>
										<td>{{cc.meetingId}}</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td ><span>{{cc.meetingDuration}}</span></td>
									</tr>
							...
							<div class="col-sm-6">
								<table class="table table-hover">
									...
									<tr>
										<td><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i>  Location</td>
										<td>{{cc.meetingLocation}}</td>
									</tr>
									<tr>
										<td><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Related To </td>
										<td>{{cc.meetingRelatedToModuleType}}</td>
									</tr>
				    		...
				    		<div class="col-sm-6">
								<table class="table table-hover">
									...
									<tr>
										...
										<td>{{cc.meetingCreateDate | date:'dd-MM-yyyy'}} By {{cc.meetingCreateBy}}</td>
									</tr>
									<tr>
										<td><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Modified Date</td>
										<td>{{cc.meetingModifiedDate | date:'dd-MM-yyyy'}} By {{cc.meetingModifiedBy}}</td>
									</tr>
