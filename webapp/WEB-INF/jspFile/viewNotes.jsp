		...
		<div class="box box-danger">
			<div class="box-header with-border">
				...
				<div style="background: #fff;margin-top: 15px;">
				 <div class="col-sm-12">
				 	...
				 	<a href="${pageContext.request.contextPath}/list-notes" class="btn btn-info btn-app" ><i class="fa fa-clone"	aria-hidden="true"></i> View</a>	
				 </div>
			...
			<div class="tablecontainer table-responsive" data-ng-init="listCase()" > 
				...
				<div class="col-sm-8 form-group">
						<a href="${pageContext.request.contextPath}/update-call/{{cc.noteId}}" class="btn btn-success custom-width"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
						<button type="button" ng-click="deleteCon(cc.noteId)" class="btn btn-danger custom-width"><i class="fa fa-times" aria-hidden="true"></i> Delete</button>
				</div>
				    ...
				    <div role="tabpanel" class="tab-pane active" id="home">
				    	<div class="col-sm-6">
								<table class="table table-hover">
									<tr>
										<td width="200px"><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Note ID</td>
										<td>{{cc.noteId}}</td>
									</tr>
									<tr>
				    		...
				    		<div class="col-sm-6">
								<table class="table table-hover">
									...
									<tr>
										...
										<td>{{cc.noteCreateDate | date:'dd-MM-yyyy'}} By {{cc.noteCreateBy}}</td>
									</tr>
									<tr>
										<td><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Modified Date</td>
										<td>{{cc.noteModifiedDate | date:'dd-MM-yyyy'}} By {{cc.noteModifiedBy}}</td>
									</tr>
