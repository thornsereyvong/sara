...
var app = angular.module('taskApp', ['angularUtils.directives.dirPagination','oitozero.ngSweetAlert']);
var self = this;
var username = "${SESSION}";
var server = "${pageContext.request.contextPath}";
var taskId = "${taskId}";
app.controller('viewTaskController',['SweetAlert','$scope','$http',function(SweetAlert, $scope, $http){
			...
			<div class="col-md-12">
				...
				<div class="box box-widget widget-user">
					...
					<div class="widget-user-header bg-aqua-active">
						...
						<h5 class="widget-user-desc" ng-if="task.taskRelatedToModule != ''">[{{task.taskRelatedToId}}]</h5>
					</div>
														...
														<div class="col-sm-4">
															<ul class="list-group list-group-unbordered">
																...
																<li class="list-group-item item_border">Relate To<a
																	class="pull-right show-text-detail">{{task.taskRelatedToId}}</a>
																	<div class="form-group show-edit" style="display: none;">
