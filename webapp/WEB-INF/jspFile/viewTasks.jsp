			...
			<div class="box-header with-border">
				...
				<div style="background: #fff;margin-top: 15px;">
				 <div class="col-sm-12">
				 	...
				 	<a href="${pageContext.request.contextPath}/list-tasks" class="btn btn-info btn-app" ><i class="fa fa-clone"	aria-hidden="true"></i> View</a>	
				 </div>
				    ...
				    <div role="tabpanel" class="tab-pane active" id="home">
				    	<div class="col-sm-6">
								<table class="table table-hover">
									<tr>
										<td width="200px"><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Task ID</td>
										<td>{{cc.taskId}}</td>
									</tr>
									<tr>
									...
									<tr>
										<td><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> 	Due Date</td>
										<td>{{cc.taskDueDate | date:'dd-MM-yyyy'}}</td>
									</tr>
									<tr>
										<td><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Priority </td>
										<td ><span>{{cc.taskPriority}}</span></td>
									</tr>
				    		...
				    		<div class="col-sm-6">
								<table class="table table-hover">
									...
									<tr>
										...
										<td>{{cc.taskCreateDate | date:'dd-MM-yyyy'}} By {{cc.taskCreateBy}}</td>
									</tr>
									<tr>
										<td><i class="fa fa-check-square-o icon_color" aria-hidden="true"></i> Modified Date</td>
										<td>{{cc.taskModifiedDate | date:'dd-MM-yyyy'}} By {{cc.taskModifiedBy}}</td>
									</tr>
